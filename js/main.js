        ...
        $.getJSON("data.json", function(data) {
            ...
            setTimeout(function(){
                ...
                setTimeout(function(){
                    ...
                    $(".center").append('<p style="text-align: center; font-size: 16px" class="animated fadeIn">每十五分鐘更新一次<br>Made by <a href="https://goo.gl/7FSJVN" target="_blank">銀行汽車貸款＿吳先生</a></p>');
                    $(".page").show();
